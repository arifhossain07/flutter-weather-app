...
class Current {
  ...
  Current.fromJson(Map<String, dynamic> json) {
    ...
    wetbulbC = json['wetbulb_c']?.toDouble();
    wetbulbF = json['wetbulb_f']?.toDouble();
...
class Day {
  ...
  Day.fromJson(Map<String, dynamic> json) {
    ...
    condition = json['condition'] != null
        ...
        : null;
    uv = json['uv']?.toDouble();
    avgwetbulbC = json['avgwetbulb_c']?.toDouble();
    avgwetbulbF = json['avgwetbulb_f']?.toDouble();
    maxwetbulbC = json['maxwetbulb_c']?.toDouble();
    maxwetbulbF = json['maxwetbulb_f']?.toDouble();
  }
